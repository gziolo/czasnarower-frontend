/*global google, Core, InfoBox, MarkerClusterer */
Core.Creator
    .register(
        'trackView',
        function(facade, $) {
          ...
          /**
           * object LatLngBounds polyBounds for keeping information about
           * current polys bounds
           */
          polysBounds,
          ...
          var _createTracks = function(map, data) {
            ...
            if (data.radius) {
              ...
              google.maps.event.addListener(map, 'dragend', function() {
                ...
                var c = map.getCenter(), x = c.lng(), y = c.lat(), maxX = area.getNorthEast().lng(), maxY = area.getNorthEast().lat(), minX = area.getSouthWest().lng(), minY = area.getSouthWest()
                    .lat();
                if (x < minX) {
                  x = minX;
                }
          ...
          var _createTrack = function(map, data) {
            ...
            var imgShadow = new google.maps.MarkerImage(facade.config.staticUrl + 'img-1.3/markers/iconset-1.png', new google.maps.Size(19, 10), new google.maps.Point(400, 32), new google.maps.Point(
                5, 5));
          ...
          /**
           * method for creating new google-maps-marker object and - binds
           * proper events
           */
