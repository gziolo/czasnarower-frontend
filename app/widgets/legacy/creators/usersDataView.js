/*global google, Core, MarkerClusterer, InfoBox */
Core.Creator.register('usersDataView', function(facade, $) {
  ...
  var _createUsersData = function(map, data) {
    ...
    $.each(data.users_data, function(i, user_data) {
      ...
      var img = new google.maps.MarkerImage(src, new google.maps.Size((mode ? 20 : 32), (mode ? 20 : 32)), new google.maps.Point(pos.x, pos.y), new google.maps.Point((mode ? 10 : 16),
          (mode ? 10 : 16)));
