...
(function(wysihtml5) {
  ...
  wysihtml5.commands.quote = {
    exec: function(composer, command) {
      return wysihtml5.commands.formatInline.exec(composer, command, "q");
    },

    state: function(composer, command, color) {
      // element.ownerDocument.queryCommandState("quote") results:
      // firefox: only <q>
      // chrome:  <q>, ...
      // ie:      <q>
      // opera:   <q>
      return wysihtml5.commands.formatInline.state(composer, command, "q");
    },
