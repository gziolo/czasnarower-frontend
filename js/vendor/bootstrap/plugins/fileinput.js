...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        removeClass: 'btn btn-xs btn-mini btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="glyphicon glyphicon-upload text-info"></i>',
        uploadClass: 'btn btn-xs btn-mini btn-default',
        uploadTitle: 'Upload file',
        zoomIcon: '<i class="glyphicon glyphicon-zoom-in"></i>',
        zoomClass: 'btn btn-xs btn-mini btn-default',
    ...
    $.fn.fileinput.defaults = {
        ...
        progressThumbClass: "progress-bar progress-bar-success progress-bar-striped active bar bar-success",
        progressClass: "progress-bar progress-bar-success progress-bar-striped active bar bar-success",
        progressCompleteClass: "progress-bar progress-bar-success bar bar-success",
        progressErrorClass: "progress-bar progress-bar-danger bar bar-danger",
