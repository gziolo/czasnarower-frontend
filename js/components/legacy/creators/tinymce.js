  ...
  return function (sandbox, $) {
    ...
    function initTextarea() {
      ...
      tinymce.init({
        ...
        menubar: false,
        paste_word_valid_elements: "b,strong,i,em,q,h1,h2,h3,h4,h5,h6,p,li,ul,ol,iframe",
        plugins: 'autolink link lists media paste preview wordcount instagram',
